...
@PAPERS
PMID== 23474651
TI  == assessment of the susceptibility of lactic acid bacteria to biocides.
AB  == biocides are antimicrobial compounds that are widely used in the food industry and medical environments. in this study, we determined the minimum inhibitory concentrations (mics) by the microdilution method of four different biocides for  a large collection of lab of different origins. the tested isolates belong to 11  species of the lactobacillus genus and to streptococcus thermophilus, streptococcus salivarius and lactococcus garvieae. the results obtained in this study indicate that low susceptibilities to benzalkonium chloride (bc), triclosan (tr), chlorhexidine (ch), and sodium hypochlorite (sh) are not frequent among lab. moreover, no systematic co-tolerance between two or more tested biocides was found; that is, strains displaying high mic values and thus low sensitivity to one of the biocides did not show higher mic values for the other biocides.
TIHT== 
ABHT== 

PMID== 20581195
TI  == detection of human intestinal catalase-negative, gram-positive cocci by rrna-targeted reverse transcription-pcr.
