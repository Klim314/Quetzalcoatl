...
@PAPERS
PMID== 21527349
TI  == re-assessment of phenotypic identifications of bacteroides putredinis to alistipes species using molecular methods.
AB  == alistipes (previously bacteroides) are strictly anaerobic gram-negative rods that resemble the bacteroides fragilis group in that most species are bile-resistant and indole-positive; however, they are only weakly saccharolytic and most species produce light brown pigment only on laked rabbit blood agar. in this retrospective study, we re-identified 18 organisms previously identified phenotypically as "bacteroides putredinis-like", but that did not produce pigment on routine media. the strains were identified with 16s rdna sequencing and pigment production was evaluated on several different culture media. only 12/18 strains had molecular identifications of alistipes species, while the remaining strains phylogenetically resembled butyricimonas and odoribacter spp. pigment production was not a reliable test for those alistipes strains that are described as pigment producers.
TIHT== 
ABHT== 
